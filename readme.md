...
```php artisan make:custom-css``` - generate css file
...
## Wallet Customization Helm chart configuration
...
The following table lists the configurable parameters of the wallet-customization chart, and their default values.
...
| appApiPathPrefix               | API prefix path. Used with internal health check functionality.                                                                  | customization                           |
...
| nameOverride                   | Override this chart name.                                                                                                        | wallet-customization                        |
