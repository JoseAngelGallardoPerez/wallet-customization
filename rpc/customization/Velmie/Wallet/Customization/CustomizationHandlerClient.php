...
/**
 * A Protobuf client that implements the {@see CustomizationHandler} interface.
 ...
 */
final class CustomizationHandlerClient implements CustomizationHandler
{
    /**
     * @var server
     */
     ...
     * {@inheritdoc}
     */
    public function GetByKey(array $ctx, \Velmie\Wallet\Customization\Request $in): \Velmie\Wallet\Customization\Response
    {
        ...
        $out = new \Velmie\Wallet\Customization\Response();

        $url = $this->addr.'/twirp/velmie.wallet.customization.CustomizationHandler/GetByKey';
