...
final class UserHandlerClient implements UserHandler
{
     ...
     * {@inheritdoc}
     */
    public function GetByUID(array $ctx, \Velmie\Wallet\Users\Request $in): \Velmie\Wallet\Users\Response
    {
     ...
     * {@inheritdoc}
     */
    public function GetByUsername(array $ctx, \Velmie\Wallet\Users\Request $in): \Velmie\Wallet\Users\Response
    {
        $ctx = Context::withPackageName($ctx, 'velmie.wallet.users');
        $ctx = Context::withServiceName($ctx, 'UserHandler');
     ...
     * {@inheritdoc}
     */
    public function GetByProfileData(array $ctx, \Velmie\Wallet\Users\Request $in): \Velmie\Wallet\Users\Response
    {
        $ctx = Context::withPackageName($ctx, 'velmie.wallet.users');
        $ctx = Context::withServiceName($ctx, 'UserHandler');
     ...
     * {@inheritdoc}
     */
    public function GetByRoleName(array $ctx, \Velmie\Wallet\Users\Request $in): \Velmie\Wallet\Users\Response
    {
        $ctx = Context::withPackageName($ctx, 'velmie.wallet.users');
        $ctx = Context::withServiceName($ctx, 'UserHandler');
     ...
     * {@inheritdoc}
     */
    public function ValidateAccessToken(array $ctx, \Velmie\Wallet\Users\Request $in): \Velmie\Wallet\Users\Response
    {
        $ctx = Context::withPackageName($ctx, 'velmie.wallet.users');
        $ctx = Context::withServiceName($ctx, 'UserHandler');
     ...
     * {@inheritdoc}
     */
    public function GetByUIDs(array $ctx, \Velmie\Wallet\Users\Request $in): \Velmie\Wallet\Users\Response
    {
        $ctx = Context::withPackageName($ctx, 'velmie.wallet.users');
        $ctx = Context::withServiceName($ctx, 'UserHandler');
     ...
     * {@inheritdoc}
     */
    public function GetByUserGroupId(array $ctx, \Velmie\Wallet\Users\Request $in): \Velmie\Wallet\Users\Response
    {
        $ctx = Context::withPackageName($ctx, 'velmie.wallet.users');
        $ctx = Context::withServiceName($ctx, 'UserHandler');
     ...
     * {@inheritdoc}
     */
    public function GetAll(array $ctx, \Velmie\Wallet\Users\Request $in): \Velmie\Wallet\Users\Response
    {
        $ctx = Context::withPackageName($ctx, 'velmie.wallet.users');
        $ctx = Context::withServiceName($ctx, 'UserHandler');
     ...
     * {@inheritdoc}
     */
    public function GetFullUsersByUIDs(array $ctx, \Velmie\Wallet\Users\RequestFullUsersByUIDs $in): \Velmie\Wallet\Users\FullUsersResponse
    {
        $ctx = Context::withPackageName($ctx, 'velmie.wallet.users');
        $ctx = Context::withServiceName($ctx, 'UserHandler');
     ...
     * {@inheritdoc}
     */
    public function GetDevicesByUID(array $ctx, \Velmie\Wallet\Users\DevicesRequest $in): \Velmie\Wallet\Users\DevicesResponse
    {
        $ctx = Context::withPackageName($ctx, 'velmie.wallet.users');
        $ctx = Context::withServiceName($ctx, 'UserHandler');
     ...
     * {@inheritdoc}
     */
    public function GetByAdministratorClassId(array $ctx, \Velmie\Wallet\Users\Request $in): \Velmie\Wallet\Users\Response
    {
        $ctx = Context::withPackageName($ctx, 'velmie.wallet.users');
        $ctx = Context::withServiceName($ctx, 'UserHandler');
     ...
     * {@inheritdoc}
     */
    public function ValidateTmpAuthToken(array $ctx, \Velmie\Wallet\Users\Request $in): \Velmie\Wallet\Users\Response
    {
        $ctx = Context::withPackageName($ctx, 'velmie.wallet.users');
        $ctx = Context::withServiceName($ctx, 'UserHandler');
     ...
     * {@inheritdoc}
     */
    public function GetStaffUsers(array $ctx, \Velmie\Wallet\Users\Request $in): \Velmie\Wallet\Users\Response
    {
        $ctx = Context::withPackageName($ctx, 'velmie.wallet.users');
        $ctx = Context::withServiceName($ctx, 'UserHandler');
     ...
     * {@inheritdoc}
     */
    public function GetCompaniesByIDs(array $ctx, \Velmie\Wallet\Users\CompaniesIDsRequest $in): \Velmie\Wallet\Users\CompaniesResponse
    {
        $ctx = Context::withPackageName($ctx, 'velmie.wallet.users');
        $ctx = Context::withServiceName($ctx, 'UserHandler');
     ...
     * {@inheritdoc}
     */
    public function SaveCompaniesByName(array $ctx, \Velmie\Wallet\Users\CompaniesNameRequest $in): \Velmie\Wallet\Users\CompaniesResponse
    {
        $ctx = Context::withPackageName($ctx, 'velmie.wallet.users');
        $ctx = Context::withServiceName($ctx, 'UserHandler');
