...
/**
 * A Protobuf client that implements the {@see PermissionChecker} interface.
 ...
 */
final class PermissionCheckerClient implements PermissionChecker
{
    /**
     * @var server
     */
     ...
     * {@inheritdoc}
     */
    public function Check(array $ctx, \Velmie\Wallet\Permissions\PermissionReq $in): \Velmie\Wallet\Permissions\PermissionResp
    {
        ...
        $out = new \Velmie\Wallet\Permissions\PermissionResp();

        $url = $this->addr.'/twirp/velmie.wallet.permissions.PermissionChecker/Check';
     ...
     * {@inheritdoc}
     */
    public function CheckAll(array $ctx, \Velmie\Wallet\Permissions\PermissionsReq $in): \Velmie\Wallet\Permissions\PermissionsResp
    {
        $ctx = Context::withPackageName($ctx, 'velmie.wallet.permissions');
        $ctx = Context::withServiceName($ctx, 'PermissionChecker');
        $ctx = Context::withMethodName($ctx, 'CheckAll');

        $out = new \Velmie\Wallet\Permissions\PermissionsResp();

        $url = $this->addr.'/twirp/velmie.wallet.permissions.PermissionChecker/CheckAll';
     ...
     * {@inheritdoc}
     */
    public function GetGroupsByIds(array $ctx, \Velmie\Wallet\Permissions\GroupIdsReq $in): \Velmie\Wallet\Permissions\GroupsResponse
    {
        $ctx = Context::withPackageName($ctx, 'velmie.wallet.permissions');
        $ctx = Context::withServiceName($ctx, 'PermissionChecker');
        $ctx = Context::withMethodName($ctx, 'GetGroupsByIds');

        $out = new \Velmie\Wallet\Permissions\GroupsResponse();

        $url = $this->addr.'/twirp/velmie.wallet.permissions.PermissionChecker/GetGroupsByIds';
