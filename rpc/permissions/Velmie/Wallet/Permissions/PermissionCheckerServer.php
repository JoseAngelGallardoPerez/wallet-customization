 ...
 */
final class PermissionCheckerServer implements RequestHandlerInterface
{
    ...
    private function handleCheck(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        ...
        switch (trim(strtolower(substr($header, 0, $i)))) {
            case 'application/json':
                $resp = $this->handleCheckJson($ctx, $req);
                break;

            case 'application/protobuf':
                $resp = $this->handleCheckProtobuf($ctx, $req);
                break;
    ...
    private function handleCheckJson(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
    ...
    private function handleCheckProtobuf(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        $ctx = Context::withMethodName($ctx, 'Check');
    ...
    private function handleCheckAll(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        $header = $req->getHeaderLine('Content-Type');
        $i = strpos($header, ';');
        ...
        switch (trim(strtolower(substr($header, 0, $i)))) {
            case 'application/json':
                $resp = $this->handleCheckAllJson($ctx, $req);
                break;

            case 'application/protobuf':
                $resp = $this->handleCheckAllProtobuf($ctx, $req);
                break;
    ...
    private function handleCheckAllJson(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
    ...
    private function handleCheckAllProtobuf(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        $ctx = Context::withMethodName($ctx, 'CheckAll');
    ...
    private function handleGetGroupsByIds(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        $header = $req->getHeaderLine('Content-Type');
        $i = strpos($header, ';');
        ...
        switch (trim(strtolower(substr($header, 0, $i)))) {
            case 'application/json':
                $resp = $this->handleGetGroupsByIdsJson($ctx, $req);
                break;

            case 'application/protobuf':
                $resp = $this->handleGetGroupsByIdsProtobuf($ctx, $req);
                break;
    ...
    private function handleGetGroupsByIdsJson(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
    ...
    private function handleGetGroupsByIdsProtobuf(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        $ctx = Context::withMethodName($ctx, 'GetGroupsByIds');
