...
/**
 * A Protobuf client that implements the {@see NotificationHandler} interface.
 ...
 */
final class NotificationHandlerClient implements NotificationHandler
{
    /**
     * @var server
     */
     ...
     * {@inheritdoc}
     */
    public function Dispatch(array $ctx, \Velmie\Wallet\Notifications\Request $in): \Velmie\Wallet\Notifications\Response
    {
        ...
        $out = new \Velmie\Wallet\Notifications\Response();

        $url = $this->addr.'/twirp/velmie.wallet.notifications.NotificationHandler/Dispatch';
     ...
     * {@inheritdoc}
     */
    public function GetSettings(array $ctx, \Velmie\Wallet\Notifications\SettingsRequest $in): \Velmie\Wallet\Notifications\SettingsResponse
    {
        $ctx = Context::withPackageName($ctx, 'velmie.wallet.notifications');
        $ctx = Context::withServiceName($ctx, 'NotificationHandler');
        $ctx = Context::withMethodName($ctx, 'GetSettings');

        $out = new \Velmie\Wallet\Notifications\SettingsResponse();

        $url = $this->addr.'/twirp/velmie.wallet.notifications.NotificationHandler/GetSettings';
     ...
     * {@inheritdoc}
     */
    public function GetUserSettings(array $ctx, \Velmie\Wallet\Notifications\UserSettingsRequest $in): \Velmie\Wallet\Notifications\UserSettingsResponse
    {
        $ctx = Context::withPackageName($ctx, 'velmie.wallet.notifications');
        $ctx = Context::withServiceName($ctx, 'NotificationHandler');
        $ctx = Context::withMethodName($ctx, 'GetUserSettings');

        $out = new \Velmie\Wallet\Notifications\UserSettingsResponse();

        $url = $this->addr.'/twirp/velmie.wallet.notifications.NotificationHandler/GetUserSettings';
